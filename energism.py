...
def filter2():
    ...
    try:
        for a in songdict:
            if (0.8<=eval(a[2])<=1.0 and 0.4<=eval(a[5])<=0.8 and 0.7<=eval(a[12])<=1.0):
                playlists['amped'][a[14]] = a
            elif (0.2<=eval(a[2])<=0.4 and 0.4<=eval(a[5])<=0.8 and 0.4<=eval(a[12])<=0.6):
                playlists['chill'][a[14]] = a
            elif (0.6<=eval(a[2])<=1.0 and 0<=eval(a[5])<=0.4 and 0.0<=eval(a[12])<=0.4):
                playlists['anger'][a[14]] = a
            elif (0.6<=eval(a[2])<=0.8 and 0.4<=eval(a[5])<=1.0 and 0.8<=eval(a[12])<=1):
                playlists['dance'][a[14]] = a
            elif (0<=eval(a[2])<=0.2 and 0<=eval(a[5])<=0.4 and 0.2<=eval(a[12])<=0.4):
                playlists['sad'][a[14]] = a
            elif (0.4<=eval(a[2])<=0.6 and 0.6<=eval(a[5])<=1 and 0.6<=eval(a[12])<=0.8):
...
#amped (energy = 80-100, valence = 60-100, danceability = 60-100, acousticness = 0-40)
#chill (energy = 20-80, valence = 40-60, dance = 20-40, acousticness = 60-100)
#anger (energy = 60-100, valence = 00-20, dance = 20-40, instrument = 0-20)
#dance (energy = 40-100, valence = 40-60, dance = 60-100, instrument = 0-20)
...
#amped (energy = 80-100, valence = 40-80, danceability = 70-100)
#chill (energy = 20-40, valence = 40-80, dance = 40-60)
#anger (energy = 60-100, valence = 00-40, dance = 00-40)
#dance (energy = 60-80, valence = 40-100, dance = 80-100)
#sad (energy = 0-20, valence = 0-40, dance = 20-40)
#happy (energy = 40-60, valence = 60-100, dance = 60-80)
...
#amped (energy = 50-100, valence = 30-70, danceability = 50-100)
#chill (energy = 00-40, valence = 40-80, dance = 40-60)
#anger (energy = 70-100, valence = 00-40, dance = 00-40)
#dance (energy = 60-80, valence = 40-100, dance = 80-100)
#sad (energy = 0-20, valence = 0-40, dance = 20-40)
#happy (energy = 40-60, valence = 60-100, dance = 60-80)
